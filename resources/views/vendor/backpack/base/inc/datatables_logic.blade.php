  <!-- DATA TABLES SCRIPT -->
  <script src="{{ asset('vendor/backpack/datatable/js/jquery.dataTables.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('vendor/backpack/datatable/js/dataTables.bootstrap.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('vendor/backpack/datatable/js/dataTables.responsive.min.js') }}"></script>
  <script src="{{ asset('vendor/backpack/datatable/js/responsive.bootstrap.min.js') }}"></script>
  <script src="{{ asset('vendor/backpack/datatable/js/dataTables.fixedHeader.min.js') }}"></script>
  <script>
  ...
  @include('vendor.backpack.custom-backpack.users.inc.export_buttons')

...
@push('crud_list_styles')
    <!-- include select2 css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('vendor/backpack/daterange/daterangepicker.css') }}" />
    <style>
        .input-group.date {
            width: 320px;
            max-width: 100%; }
...
@push('crud_list_scripts')
    <script type="text/javascript" src="{{ asset('vendor/backpack/daterange/moment.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/backpack/daterange/daterangepicker.js') }}"></script>
    <script>
